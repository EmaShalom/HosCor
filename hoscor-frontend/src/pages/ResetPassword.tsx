      ...
      <div className="min-h-screen bg-[#F8F9FA] flex items-center justify-center">
        <div className="w-full max-w-sm">
          <div className="bg-white border border-[#E5E7EB] rounded-2xl p-8 shadow-sm text-center">
            ...
            <h2 className="text-xl font-bold text-[#111827] mb-2">{t('resetPassword.successTitle')}</h2>
            <p className="text-sm text-[#6B7280] mb-6">{t('resetPassword.successMessage')}</p>
            <button
      ...
      <div className="w-full max-w-sm">
        <div className="bg-white border border-[#E5E7EB] rounded-2xl p-8 shadow-sm">
          <div className="text-center mb-6 relative">
            ...
            <h1 className="text-xl font-bold text-[#111827]">{t('resetPassword.title')}</h1>
            <p className="text-sm text-[#6B7280] mt-2">{t('resetPassword.subtitle')}</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              <input
                ...
                className="w-full border border-[#D1D5DB] rounded-lg px-3 py-2.5 text-sm text-[#111827] placeholder-[#9CA3AF] focus:outline-none focus:ring-2 focus:ring-[#2563EB]"
